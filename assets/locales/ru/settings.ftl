...
На бесплатном тарифе активен базовый поток сигналов. Чтобы настроить терминал под свою стратегию, оформите VIP-подписку.
paywall-settings-locked-banner = 💎 Чтобы настроить фильтры под свою стратегию — оформите VIP-подписку. На бесплатном тарифе активен базовый поток сигналов.
kb-settings-buy-vip = 💎 Разблокировать настройки (VIP)
